...
class BodyCheckinPage extends StatefulWidget {
  final VoidCallback onComplete;
  final StorageService storage;

  const BodyCheckinPage({
    super.key,
  ...
  @override
  State<BodyCheckinPage> createState() => _BodyCheckinPageState();
}

class _BodyCheckinPageState extends State<BodyCheckinPage> {
